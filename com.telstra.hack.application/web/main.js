...
(function() {
	...
	var MODULE = angular.module('com.telstra.hack',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/com.telstra.hack/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/com.telstra.hack/main/htm/about.htm'});
